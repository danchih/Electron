...
app.post('/cadastro', (req, res) => {
    const { nome, email, password, endereco, cep } = req.body;
    connection.query('INSERT INTO users (nome, email, password, endereco, cep) VALUES (?, ?, ?, ?, ?)', [nome, email, password, endereco, cep], (error, results) => {
        if (error) {
